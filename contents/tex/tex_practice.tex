...
このあたりは\url{https://togetter.com/li/1124861}などを参考にして，各自調べること\footnote{%
  結論を言うと，文書クラスがbxjsclassesであればクラスオプション\texttt{label-section=modern}を指定し，\texttt{\textbackslash thesection}の代わりに\texttt{\textbackslash pre}/\texttt{\textbackslash postsectionname}をカスタマイズすれば良い．
